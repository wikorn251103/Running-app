...
import com.example.myproject.databinding.FragmentEditUserTrainingBinding
import com.google.firebase.firestore.FirebaseFirestore

class EditUserTrainingFragment : Fragment() {

    private var _binding: FragmentEditUserTrainingBinding? = null
    ...
    companion object {
        private const val TAG = "EditUserTraining"
        private const val ARG_USER_ID = "user_id"
        private const val ARG_USER_NAME = "user_name"
        private const val ARG_PROGRAM_ID = "program_id"

        fun newInstance(userId: String, userName: String, programId: String): EditUserTrainingFragment {
            val fragment = EditUserTrainingFragment()
            val bundle = Bundle()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentEditUserTrainingBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.tvProgramTitle.text = "แก้ไขตาราง: $userName"
    ...
    /**
     * โหลดข้อมูลของวันที่เลือกจาก Athletes/{userId}
     */
    ...
    /**
     * บันทึกข้อมูลไปที่ Athletes/{userId}
     */
    private fun saveDayData() {
        ...
        firestore.collection("Athletes")
            .document(userId)
            .update(updatePath, dayData, "lastUpdated", System.currentTimeMillis())
            .addOnSuccessListener {
                binding.progressBar.visibility = View.GONE
                binding.btnSave.isEnabled = true
                Toast.makeText(requireContext(), "✅ บันทึกสำเร็จ", Toast.LENGTH_SHORT).show()
                Log.d(TAG, "Saved: Week $currentWeek, Day $currentDay for user $userId")
            }
            .addOnFailureListener { e ->
